...
export class PromotionsService {
  ...
  async create(createPromotionDto: CreatePromotionDto): Promise<any> {
    ...
    try {
      ...
      const existingPromotion = await this.promotionModel.findOne({ name }).exec();
      if (existingPromotion) {
        return createResponse('DuplicatedRecord', null, 'Promotion with this name already exists');
      }
      ...
      return createResponse('ServerError', null, 'An error occurred while creating the promotion');
    }
  }
  ...
  async findAll(): Promise<any> {
    try {
      ...
      return createResponse('ServerError', null, 'An error occurred while fetching promotions');
    }
  }
  ...
  async findOne(id: string): Promise<any> {
    ...
    try {
      ...
      return createResponse('ServerError', null, 'An error occurred while fetching the promotion');
    }
  }

  // Update a promotion by ID
  async update(id: string, updatePromotionDto: UpdatePromotionDto): Promise<any> {
    ...
    try {
      return createResponse('OK', updatedPromotion, 'Promotion updated successfully');
    } catch (error) {
      return createResponse('ServerError', null, 'An error occurred while updating the promotion');
    }
  }
  ...
  async remove(id: string): Promise<any> {
    ...
    try {
      ...
      return createResponse('ServerError', null, 'An error occurred while deleting the promotion');
    }
  }
}
