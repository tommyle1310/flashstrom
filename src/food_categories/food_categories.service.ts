...
export class FoodCategoriesService {
  ...
  async create(createFoodCategoryDto: CreateFoodCategoryDto): Promise<any> {
    ...
    try {
      ...
      const existingCategory = await this.foodCategoryModel.findOne({ name }).exec();
      if (existingCategory) {
        return createResponse('DuplicatedRecord', null, 'Food category with this name already exists');
      }
      ...
      return createResponse('OK', newFoodCategory, 'Food category created successfully');
    } catch (error) {
      return createResponse('ServerError', null, 'An error occurred while creating the food category');
    }
  }
  ...
  async findAll(): Promise<any> {
    try {
      ...
      return createResponse('OK', foodCategories, 'Fetched all food categories');
    } catch (error) {
      return createResponse('ServerError', null, 'An error occurred while fetching food categories');
    }
  }
  ...
  async findOne(id: string): Promise<any> {
    ...
    try {
      return createResponse('OK', foodCategory, 'Fetched food category successfully');
    } catch (error) {
      return createResponse('ServerError', null, 'An error occurred while fetching the food category');
    }
  }

  // Update a food category by ID
  async update(id: string, updateFoodCategoryDto: UpdateFoodCategoryDto): Promise<any> {
    ...
    try {
      return createResponse('OK', updatedFoodCategory, 'Food category updated successfully');
    } catch (error) {
      return createResponse('ServerError', null, 'An error occurred while updating the food category');
    }
  }

  // Delete a food category by ID
  async remove(id: string): Promise<any> {
    const deletedFoodCategory = await this.foodCategoryModel.findByIdAndDelete(id).exec();
    ...
    try {
      ...
      return createResponse('ServerError', null, 'An error occurred while deleting the food category');
    }
  }
}
