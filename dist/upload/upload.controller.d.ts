...
export declare class UploadController {
    ...
    constructor(restaurantService: RestaurantsService, uploadService: UploadService, driverService: DriversService, adminService: AdminService, customerService: CustomersService, menuItemService: MenuItemsService);
